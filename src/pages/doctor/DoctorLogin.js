...
function DoctorLogin({ updateDoctor,updateDoctorToken }) {
	...
	const DoctorLogin = async () => {
		console.log(doctor);
		try {
			const response = await axios.post("http://localhost:8888/doctor/doctorSignin", doctor)
				.then(res => {
					console.log('res', res);
						...
						<div class="col-lg-8 col-xl-6">
							<div class="card rounded-3">
								...
								<div class="card-body p-4 p-md-5">
									...
									<form class="px-md-2" method="post"  onSubmit={(e) => refresh(e)}>
										...
										<button type="submit"
											...
											onClick={() => DoctorLogin()}>Login</button>
									</form>
