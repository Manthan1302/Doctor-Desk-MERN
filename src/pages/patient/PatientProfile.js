                    ...
                    <div className="col-xl-4">
                        <div className="card mb-4 mb-xl-0">
                            ...
                            <div className="card-body text-center">
                                ...
                                <p className="card-text"><b>Name:</b>{getPatient.patientName}</p>
                                <p className="card-text"><b>Email:</b> {getPatient.patientEmail}</p>
                                <p className="card-text"><b>Phone number:</b> {getPatient.patientPhoneNumber}</p>
                                <p className="card-text"><b>Age:</b> {getPatient.patientAge}</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-8">
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                <form className="px-md-2" onSubmit={(e) => refresh(e)} method="post">
                                    <div className="row gx-3 mb-3">
                                        <div className="col-md-6">
                                            <label className="small mb-1" for="inputFirstName">Name</label>
                                            <input className="form-control" type="text" name="patientName"
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input className="form-control" id="inputLastName" type="text"
                                                ...
                                                onChange={takeInput} name="patientAge" placeholder="Enter your last name" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="row gx-3 mb-3">
                                        <div className="col-md-6">
                                            ...
                                            <input className="form-control" id="inputEmailAddress" value={patient.patientEmail}
                                                pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}"
                                                onChange={takeInput} name="patientEmail" type="email" placeholder="Enter your email address" />
                                        </div>
                                        <div className="col-md-6">
                                            <label className="small mb-1" for="inputPhone">Phone number</label>
                                            <input className="form-control" id="inputPhone" value={patient.patientPhoneNumber}
                                                pattern="[6-9]\d{9}"
                                                title="Incorrect Mobile Number"

                                                onChange={takeInput} type="tel" name="patientPhoneNumber" placeholder="Enter your phone number" />
                                        </div>
                                    </div>
                                    <button className="btn btn-primary" type="submit" onClick={updatePatientProfile}>Save changes</button>
                                </form>
                            </div>
                        </div>
                    </div>
